...
|损失函数值|拟合结果|
|---|---|
|![](./IMGs/sin_loss_2p.png)|![](./IMGs/sin_result_2p.png)|
#### （2）用三次多项式拟合
...
|损失函数值|拟合结果|
|---|---|
|![](./IMGs/sin_loss_3p.png)|![](./IMGs/sin_result_3p.png)|
#### (3)双层神经网络实现非线性回归
#### ①定义神经网络结构
...
## 三、总结
这次课我们继续学习了分类问题，与上次不同的地方在于，这次我们学习的是非线性分类问题。即在原有的在两层神经网络之间，必须有激活函数连接，再加入非线性因素，提高神经网络的能力。从激活函数开始，一类是挤压型的激活函数，常用于简单网络的学习；另一类是半线性的激活函数，常用于深度网络的学习。在此基础上探究非线性问题的解决方法--非线性回归。

这次课学的第二块是针对单入单出的双层神经网络，使用数学中的多项式回归方法去拟合一些曲线。非线性问题在工程实践中比较常见，所以自然界中更多的问题是非线性的而不是线性的。
